            ...
            switch (c) {
                ...
                case ':':
                    if (advance() == '=') {
                        ...
                        Imp.logCompileError(new Token(ERROR, tmpline, tmpindex, ":"), "':' character requires ':='.");
                    }
                    break;
                case ';':
                ...
                default:
                    if (isNum(c)) {
                        ...
                        Imp.logCompileError(new Token(ERROR, tmpline, tmpindex, Character.toString(c)), "Unexpected Character.");
                    }
                    break;
            }
        }
